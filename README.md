...
- 🛡️ **Quality gates** — CI enforces lint + unit tests (covering the simulation engine's geometry sampling / time integration / data fallback) + build; a global ErrorBoundary and `prefers-reduced-motion` support round it out
...
├── tests/worldEngine.test.js # Engine unit tests (vitest)
└── public/
